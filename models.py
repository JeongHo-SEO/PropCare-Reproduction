...
# from utils import squared_dist, find_k_smallest // IGNORE
...
class Causal_Model(Model, ABC):
    ...
    def propensity_train(self, data):
        ...
        # self.estimator_optimizer.minimize(loss, self.trainable_weights, tape=tape2) // keras version issue, from Keras 3
        grads = tape2.gradient(loss, self.trainable_weights)
        self.estimator_optimizer.apply_gradients(zip(grads, self.trainable_weights))
